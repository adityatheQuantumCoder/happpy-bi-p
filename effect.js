...
$('document').ready(function(){
		...
		$(window).resize(function(){
            ...
            // Random balloons resize
			$('#b11').animate({top:240, left: vw-350},500);
			$('#b22').animate({top:240, left: vw-250},500);
			$('#b77').animate({top:240, left: vw+250},500);
            
            // ARYA balloons resize (vertical only, CSS handles left)
    ...
    /* --- BALLOON LOOPS --- */
    // 1, 2, and 7 move randomly anywhere on the screen
	function loopOne() {
    ...
    // ARYA Balloons (3, 4, 5, 6) only float straight up so they stay centered
	function loopThree() {
		var randtop = 500*Math.random();
    ...
    // Targets .cake-cover for the smooth fade in
	...
	$('#wish_message').click(function(){
		...
		$('#b1,#b2,#b3,#b4,#b5,#b6,#b7').stop();
		$('#b1').attr('id','b11'); $('#b2').attr('id','b22');
		$('#b3').attr('id','b33'); $('#b4').attr('id','b44');
		$('#b5').attr('id','b55'); $('#b6').attr('id','b66');
		$('#b7').attr('id','b77');
        
        // Random background balloons to the edges
		$('#b11').animate({top:240, left: vw-350},500);
		$('#b22').animate({top:240, left: vw-250},500);
		$('#b77').animate({top:240, left: vw+250},500);
        
        // ARYA balloons line up neatly (only moving to top: 240)
		$('#b33').animate({top:240},500);
		$('#b44').animate({top:240},500);
		$('#b55').animate({top:240},500);
		$('#b66').animate({top:240},500);
